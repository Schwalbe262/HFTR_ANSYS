...
# Open aedt file
oDesktop.OpenProject("D:/script/ML_aedt/ML_comp_v2.aedt")

# Make project
oProject = oDesktop.SetActiveProject("ML_comp_v2")
oProject.InsertDesign("HFSS", "HFSS_ML_comp_v$VERSION_IDX_STR", "DrivenTerminal", "")
oDesign = oProject.SetActiveDesign("HFSS_ML_comp_v$VERSION_IDX_STR")
...
oProject.Save()
oDesign.Analyze("Setup1")
oModule.ExportToFile(" Table 1", "D:/script/ML_v2_data/Data_comp $VERSION_IDX_STR.csv", False)
#time.sleep(1)
...
oProject.DeleteDesign("HFSS_ML_comp_v$VERSION_IDX_STR")
#time.sleep(1)
oProject.Save()
